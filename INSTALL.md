...
- Install the Lab Streaming Layer https://github.com/sccn/labstreaminglayer. Familiarize yourself with this tool. You need to be able to connect to your EEG hardware and use the LabRecorder to save data from your hardware, then open and inspect that data under the EEGLAB software (for example).
